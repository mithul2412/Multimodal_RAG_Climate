...
def judge_generation(
    ...
    **kwargs,  # accepts groq_client etc. for backward compat, ignored
    ...
    try:
        ...
        relevance = max(0.0, min(1.0, float(scores.get("relevance", 0.0))))
        completeness = max(0.0, min(1.0, float(scores.get("completeness", 0.0))))
        ...
        print(f"    Generation scoring error: {e}")
